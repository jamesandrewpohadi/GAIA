...
func _ready():
	...
	for player in ["Sniper","cheowfu","cyclops","edricwu","edricwu2","jaexp","james","jamesandrewpohadi","pohadi","sanjay","sudiptac","terragrove"]:
		put("users/"+player+"/game/buildings", '{"academyBuilding":0,"cementBuilding":0,"foodBuilding":0,"oreBuilding":0,"treeBuilding":0,"waterBuilding":0}')
		yield(self,"done")
	#put("users/jaexp", '{"GRO":1000,"game":{"friends":"","mangrove":100,"market":{"cement":10,"food":10,"ore":10,"water":10},"population":100,"resources":{"cement":10,"food":10,"ore":10,"water":10},"wealth":100},"mail":'+'"jaexp.bots@gmail.com"'+'}')
	pass
